...
function show_module_intro($term_id) {
    ...
    echo '<input type="hidden" name="lesson_id" value="' . get_first_lesson_id($term_id) . '">';
    echo '<input type="hidden" name="exercise_number" value="1">';
    echo '<input type="hidden" name="stage" value="lesson_intro">';
    echo '<input type="submit" value="Start Module">';
    echo '</form>';
}
